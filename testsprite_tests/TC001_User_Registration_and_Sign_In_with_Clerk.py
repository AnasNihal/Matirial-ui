...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the sign-up page by clicking the Login link or Get Started button.
        frame = context.pages[-1]
        # Click the Login link to navigate to the sign-up/sign-in page.
        ...
        # -> Input valid email and password, then click Continue to register.
        frame = context.pages[-1]
        # Enter valid email address for registration.
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Registration Successful! Welcome, testuser@example.com').first).to_be_visible(timeout=30000)
        except AssertionError:
            raise AssertionError("Test plan execution failed: User registration and login verification did not succeed as expected using Clerk authentication system.")
