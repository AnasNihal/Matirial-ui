...
async def run_test():
    ...
    try:
        ...
        # -> Click on Login to access user settings for plan upgrade.
        ...
        # -> Input valid email address to proceed with login.
        frame = context.pages[-1]
        ...
        # -> Click on 'Sign up' link to create a new user account for testing.
        frame = context.pages[-1]
        ...
        # -> Input email and password to create a new user account.
        frame = context.pages[-1]
        # Input email address for new user account creation
        elem = frame.locator('xpath=html/body/div/div/div/div/div[2]/form/div/div/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('testuser@example.com')
        ...
        # -> Click on 'Sign in' link to return to login page and try alternative approach or report issue.
        frame = context.pages[-1]
        # Click on 'Sign in' link to return to login page
        elem = frame.locator('xpath=html/body/div/div/div/div[2]/div/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Input valid email address for login attempt.
        frame = context.pages[-1]
        # Input valid existing user email for login attempt
        elem = frame.locator('xpath=html/body/div/div/div/div/div[2]/form/div/div/div/div/input').nth(0)
        ...
        try:
            ...
            raise AssertionError("Test plan execution failed: Subscription upgrade to Pro plan using Stripe payment did not complete successfully, or Pro features like SMARTAI are not accessible, or payment failure handling is incorrect.")
