...
const config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        'in-active': 'var(--app-border-secondary)',
        connector: '#F0F1F6',
        ...
        'light-blue': '#3352CC',
        'background-90': 'var(--app-card-bg)',
        'background-80': 'var(--app-bg-secondary)',
        ...
        'app-border-secondary': 'var(--app-border-secondary)',
        'app-blue': 'var(--app-blue)',
        'app-blue-light': 'var(--app-blue-light)',
        'app-blue-dark': 'var(--app-blue-dark)',
