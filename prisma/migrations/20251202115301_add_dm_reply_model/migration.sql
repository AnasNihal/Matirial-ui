...
CREATE TABLE "DmLink" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "dmReplyId" UUID NOT NULL,
    "title" TEXT NOT NULL,
    "url" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "DmLink_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "DmReply_automationId_key" ON "DmReply"("automationId");
...
-- AddForeignKey
ALTER TABLE "Listener" ADD CONSTRAINT "Listener_dmReplyId_fkey" FOREIGN KEY ("dmReplyId") REFERENCES "DmReply"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DmReply" ADD CONSTRAINT "DmReply_automationId_fkey" FOREIGN KEY ("automationId") REFERENCES "Automation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DmLink" ADD CONSTRAINT "DmLink_dmReplyId_fkey" FOREIGN KEY ("dmReplyId") REFERENCES "DmReply"("id") ON DELETE CASCADE ON UPDATE CASCADE;
