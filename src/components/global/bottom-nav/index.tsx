        ...
        <Sheet open={isMoreOpen} onOpenChange={setIsMoreOpen}>
          <SheetTrigger asChild>
            ...
            >
              ...
              <span className={cn('text-[10px] font-medium', isMoreOpen ? 'text-app-blue' : 'text-text-secondary')}>
                More
              </span>
            </button>
          </SheetTrigger>
          <SheetContent side="right" className="w-[280px] bg-app-bg-primary border-app-border p-0">
