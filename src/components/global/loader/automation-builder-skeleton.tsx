    ...
    <div className="flex flex-col gap-y-8 animate-pulse">
      ...
      <div className="flex items-center justify-between gap-x-4 bg-[#111] border border-[#2a2a2a] rounded-2xl px-5 py-4">
        <div className="flex items-center gap-x-3">
          ...
          <div>
            <div className="h-3 w-20 bg-gray-800 rounded mb-2"></div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="flex justify-center">
          <div className="w-[300px] h-[600px] bg-[#1D1D1D] border border-[#545454] rounded-3xl"></div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Panel cards */}
          {[1, 2, 3].map((i) => (
            <div key={i} className="rounded-xl border border-[#2a2a2a] bg-[#101010] p-4">
